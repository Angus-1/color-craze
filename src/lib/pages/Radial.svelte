<script>
    ...
    import { colors_r } from "$lib/data/radial_colors";
  ...
  >
    <Text>
      <div class="text-center">
        ...
        <div class = "text-2xl m-6 font-light" > Radial gradients </div>
  
  
      <div class="row">
        {#each colors_r as {title,color1, color2,color3, descr,}, i}
          <div class="flip-box">
            <div class="flip-box-inner" class:show-back={selected === i}>
              ...
              <br>
              <input name="color-3" type="color" bind:value={color3}/>
              </div>
  
              <div class="flip-box-back container">
                <p>{title}</p>
                radial-gradient
                <br> ({color1.toString(16)},
                 <br>{color2.toString(16)}
                 <br>{color3.toString(16)});
  ...
  <style>
      ...
      linear-gradient(90deg, rgb(55, 75, 129),rgb(55, 72, 129));
          ...
          width: 12.5rem;
          height: 12.5rem;
          background: radial-gradient(var(--gradient-1) , var(--gradient-2),var(--gradient-3));
          border-radius: 10px;
      }	
